...
<head>
    ...
    <title>Animais</title></head>
<body>
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-12 col-sm-8 com-md-6">
                <form method="post">
...
<
        ...
        if(isset($_POST['animal'])){
            if($_POST['animal'] == 1){
                echo '<img src="img/cachorro.jpg" alt="Animal" class="img-fluid p-2 rounded">';
            }else{
                echo '<img src="img/gato.jpg" alt="Animal" class="img-fluid p-2 rounded">';
            }
        }else{
